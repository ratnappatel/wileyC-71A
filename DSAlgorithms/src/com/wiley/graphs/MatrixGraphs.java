...
public class MatrixGraphs {
  ...
  public static void main(String args[]) {
    ...
    graph.addEdge(1, 2); // DEFINING RELATION BETWEEN TWO NODE/VERTICES
    graph.addEdge(1, 5);
    graph.addEdge(2, 5);
    graph.addEdge(1, 2);
    graph.addEdge(2, 3);
...
class AdjacencyMatrixGraph {
  ...
  private int[][] _adjacency; // MATRIX HOLDS A GRAPH
  ...
  private void setAdjacency(int[][] newAdjacency) {
    this._adjacency = newAdjacency; // FIELD AS MATRIX ASSIGNING 
  }
